<template>
    <div>
        <Modal v-model="landUseShowTemp" draggable scrollable footer-hide :mask="false" title="土地利用统计" width="550px"
    ...
    watch: {
        ...
        data(newValue) {
            ...
            if (newValue.length == 0) this.disabled = true;
                ...
                if (this.$store.getters.AttributeSelect == "LandUse") this.radius_tableData_Change();
            }
