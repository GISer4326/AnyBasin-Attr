<template>
    <Modal v-model="visualizationFrozenSoilShowTemp" draggable scrollable footer-hide :mask="false" title="模拟结果可视化"
...
export default {
    ...
    data() {
        return {
            ...
            chart111: null,
            date: ["a", "b", "c", "d", "e", "f", "g", "h", "j", "k", "l", "m", "n"],
    ...
    methods: {
        initChart() {
            ...
            function init() {
                ...
                let geometry = new THREE.CylinderGeometry(12, 12, 100, 30, 50);
                geometry.center();
